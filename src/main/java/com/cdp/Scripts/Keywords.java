...
public class Keywords {
	...
	public String verifyTitle(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
		try {
	...
	public String verifyText(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
		try {
	...
	// *****verifyText Method*********
	// METHOD WILL verifyText For Links/Buttons/Label
	public String verifyTextCSS(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
		try {
			MainThread.APP_LOGS.debug("Verifying Text");
	...
	public String verifyWaterMarkAvailability(WebDriver driver, String browser, String target, String data,
			File SubFolderPath, String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID,
			String user, Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName)
			throws InterruptedException, IOException {
		try {
			String ActText = driver.findElement(By.xpath(MainThread.CONFIG.getProperty(target)))
	...
	public String verifyWaterMarkUnAvailability(WebDriver driver, String browser, String target, String data,
			File SubFolderPath, String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID,
			String user, Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName)
			throws InterruptedException, IOException {
	...
	public String VendorSearch(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
		try {
	...
	public String Type(WebDriver driver, String browser, String target, String data, File SubFolderPath, String TCID,
			String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
	...
	public String ActionType(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) {
		try {
			if (actions == null) {
	...
	public String DragAndDrop(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) {
		try {
	...
	public String ActionClick(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) {
		try {
			if (actions == null) {
	...
	public String MouseHover(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) {
		try {
			if (actions == null) {
	...
	public String Click(WebDriver driver, String browser, String target, String data, File SubFolderPath, String TCID,
			String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
		// APP_LOGS.debug("Input The Value In Test Box");
		try {
	...
	public String verifySignIn(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
		// APP_LOGS.debug("Input The Value In Test Box");
		try {
	...
	public String Clickhidden(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
		// APP_LOGS.debug("Input The Value In Test Box");
		for (int i = 1; i <= 5; i++) {
	...
	public String verifyErrMsg(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
		// APP_LOGS.debug("Input The Value In Test Box");
		try {
	...
	public String Browserwait(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
		// APP_LOGS.debug("Input The Value In Test Box");
		try {
	...
	public String Module_layer(WebDriver driver, String browser,  String target, String data, File SubFolderPath, String TCID, String TSID,  String DSID, String Correct_Data, int currentTestDataSetID, String user, Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException{
		   //APP_LOGS.debug("Input The Value In Test Box");
		   try{
		    String tar[]=target.split("\\&");
	...
	public String validateList(WebDriver driver, String browser, String target, String data, File SubFolderPath,
		...
		// APP_LOGS.debug("Get Title OF Opened Web Application");
		try {
			List<WebElement> Listcount = driver.findElements(By.xpath(MainThread.CONFIG.getProperty("widgets_Length")));
					System.out.println("list size" +Listcount.size());
						 for(int i=1;i<=Listcount.size();i++){
							 System.out.println("listcount" +Listcount.get(i));
	...
	public String isVisible(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
		// APP_LOGS.debug("Input The Value In Test Box");
		try {
	...
	public String verifyTextContains(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
		// APP_LOGS.debug("Get Title OF Opened Web Application");
		try {
	...
	public String verifyTextBoxValue(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
		// APP_LOGS.debug("Get Title OF Opened Web Application");
		try {
	...
	public String verifyLogout(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
		// APP_LOGS.debug("Input The Value In Test Box");
		try {
	...
	public String uploadPhoto(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
		// APP_LOGS.debug("Get Title OF Opened Web Application");
		try {
			if (driver.equals("FF")) {
				...
				Runtime.getRuntime()
						.exec("D:\\MyChoiceAutomationFramework\\MyChoiceAutomationFramework\\src\\uploadFF.exe");
				return "PASS";
			} else {
				// String path = System.getProperty("User.dir")+"\\src\\uploadChrome.exe";
				Runtime.getRuntime()
						.exec("D:\\MyChoiceAutomationFramework\\MyChoiceAutomationFramework\\src\\uploadChrome.exe");
				return "PASS";
			}
		} catch (Exception e) {
			ScreenShot(driver, browser, target, data, SubFolderPath, TCID, TSID, DSID, Correct_Data,
	...
	public String ClearText(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
		// APP_LOGS.debug("Input The Value In Test Box");
		try {
	...
	public String Backspace(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
		// APP_LOGS.debug("Input The Value In Test Box");
		try {
	...
	public String randomEmail(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
		// APP_LOGS.debug("Get Title OF Opened Web Application");
		try {
	...
	public String randomName_Withoutnumbers(WebDriver driver, String browser, String target, String data,
			File SubFolderPath, String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID,
			String user, Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) {
		// APP_LOGS.debug("Get Title OF Opened Web Application");
		try {
			...
			for (int i = 0; i < 3; i++) {
				...
				// MainThread.currentTestSuiteXLS.setCellData(MainThread.currentTestCaseName,
				// "NAME", currentTestDataSetID, names);
			}

			return "PASS";
		} catch (Exception e) {
			// ScreenShot( driver, browser, target, data, SubFolderPath, TCID, TSID, DSID,
			// Correct_Data, currentTestDataSetID, user);
			e.printStackTrace();
			return "FAIL";
		}
	}

	public String randomName(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
		// APP_LOGS.debug("Get Title OF Opened Web Application");
		try {
	...
	public String charbychar(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
		// APP_LOGS.debug("Get Title OF Opened Web Application");
		try {
			...
			for (i = 0; i < name.length(); i++) {
				...
				driver.findElement(By.xpath(MainThread.CONFIG.getProperty(target)))
						.sendKeys(Character.toString(name.charAt(i)));
				Thread.sleep(1000);
			}
			return "PASS";
		} catch (Exception e) {
	...
	public String SelectDropdownValue(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
		try {
			if (data.equals("")) {
	...
	public String switchToWindow(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
		// APP_LOGS.debug("Get Title OF Opened Web Application");
		try {
			...
			// int
			// rowNum=driver.findElements(By.xpath(MainThread.CONFIG.getProperty(tar[1]))).size();
			int count = 0;
			...
			if (colNum > 0) {
				for (int pg = 3; pg <= numPages - 2; pg++) {
						...
						for (int cc = 1; cc <= colNum; cc++) {
							...
							String elementText = driver
									.findElement(By.xpath(
											MainThread.CONFIG.getProperty(tar[1]) + "[" + rc + "]/td[" + cc + "]"))
									.getText();
							// System.out.println("Page number"+pg+"element in row num--->"+rc+"column
							// num--->"+cc+"is--->"+elementText);
					...
					driver.findElement(By.xpath(MainThread.CONFIG.getProperty(tar[0]) + "[" + (pg + 1) + "]/a"))
							.click();
				}
				return "PASS";
			} else {
	...
	public String validateListContent(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
		// APP_LOGS.debug("Get Title OF Opened Web Application");
		try {
	...
	/*
	 * public String ScreenShot(WebDriver driver, String browser, String target,
	 * String data, File SubFolderPath, String TCID, String TSID, String DSID,
	 * String Correct_Data, int currentTestDataSetID, String user, Xlsx_Reader
	 * currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException,
	 * IOException{ try{ WebDriver element; WebDriver wrapsDriver = (WebDriver)
	 * element; File screenshot = ((TakesScreenshot)
	 * wrapsDriver).getScreenshotAs(OutputType.FILE); Rectangle rectangle = new
	 * Rectangle(element.getSize().width, element.getSize().height, 0, 0); Point
	 * location = element.getLocation(); BufferedImage bufferedImage =
	 * ImageIO.read(screenshot); BufferedImage destImage =
	 * bufferedImage.getSubimage(location.x, location.y, rectangle.width,
	 * rectangle.height); ImageIO.write(destImage, "png", screenshot); File file =
	 * new File("//path//to"); FileUtils.copyFile(screenshot, file); return "PASS";
	 * }catch(Exception e){ //MainThread.APP_LOGS.debug(e); e.printStackTrace();
	 * return "FAIL"; } } }
	 */
	...
	public String ERPASSScreenShot(WebDriver driver, String browser, String target, String data,
		...
		try {
		    ...
		    String filenamepath = filepath+TCID+"-"+TSID+filetype;
		    FileUtils.copyFile(file, new File(filenamepath));
		    logger.log(LogStatus.PASS, TSID , logger.addScreenCapture(filenamepath));
			return "PASS";
		} catch (Exception e) {
			// MainThread.APP_LOGS.debug(e);
			e.printStackTrace();
	...
	public String resetApp(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) {
		try {
	...
	public String ConnectDB(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) {
		try {

			Class.forName("com.mysql.jdbc.Driver");
			Connection con = DriverManager.getConnection("jdbc:mysql://172.16.3.1:3306", "root", "admin123");
	...
	public String validateCreatePolicy(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
		// APP_LOGS.debug("Click on Button");
		try {
			if (data.equals("Y")) {
				boolean PolicyManagementHdr = driver
						.findElement(By.xpath(MainThread.CONFIG.getProperty("PolicyManagementHdr"))).isDisplayed();
				boolean SelectedPolicy = driver.findElement(By.xpath(MainThread.CONFIG.getProperty("SelectedPolicy")))
						.isDisplayed();
				...
				boolean CreatePolicy = driver
						.findElement(By.xpath(MainThread.CONFIG.getProperty("CreatePolicySaveBtn"))).isEnabled();
	...
	public String verifyErrorMsg(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
		// APP_LOGS.debug("Get Title OF Opened Web Application");
		try {
	...
	// *****SelectList Method**********
	// METHOD WILL SELECT INSTITUTION FROM DROPDOWN LIST & VALIDATES BEFORE
	// SELECTING THE INSTITUTION WITH DROP LIST INSTITUTIONS
	public String SelectList(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
	...
	public String btnmode(WebDriver driver, String browser, String target, String data, File SubFolderPath, String TCID,
			String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
		try {
	...
	public String isLocationSelected(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
		// APP_LOGS.debug("Input The Value In Test Box");
		try {
	...
	public String VerifyPaging(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
		// APP_LOGS.debug("Input The Value In Test Box");
		try {
			...
			for (int i = 1; i <= 1000; i++) {
				driver.findElement(By.xpath(MainThread.CONFIG.getProperty(target) + "[" + elements.size() + "]/a"))
						.click();
				rightnav = driver
						.findElement(By.xpath(MainThread.CONFIG.getProperty(target) + "[" + elements.size() + "]"))
						.getAttribute("class");
			...
			for (int j = 1; j <= 1000; j++) {
				...
				rightnav2 = driver.findElement(By.xpath(MainThread.CONFIG.getProperty(target) + "[" + 1 + "]"))
						.getAttribute("class");
			...
			/*
			 * Int LastPageNum=elements.size()-1; int
			 * MaxPageNum=driver.findElement(By.xpath(
			 * "//*[@id='verizonView']/div/div[2]/div/div[2]/div/div[2]/div/div[2]/div/div/div/ul/li["
			 * +LastPageNum+"]/a/span")).getText(); //int Maxpages=int(MaxPageNum); for(int
			 * k=3; k<=MaxPageNum; k++){ driver.findElement(By.xpath(
			 * "//*[@id='verizonView']/div/div[2]/div/div[2]/div/div[2]/div/div[2]/div/div/div/ul/li["
			 * +k+"]/a/span")).click(); rightnav2=
			 * driver.findElement(By.xpath(MainThread.CONFIG.getProperty(target)+"["+1+"]"))
			 * .getAttribute("class"); System.out.println("rightnav2="+rightnav2);
			 * if(rightnav2.contains("disabled")){ break; } }
			 */
			System.out.println("rightnav=" + rightnav);
	...
	public String verifyLMSearch(WebDriver driver, String browser, String target, String data, File SubFolderPath,
			String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID, String user,
			Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName) throws InterruptedException, IOException {
		// APP_LOGS.debug("Input The Value In Test Box");
		try {
			...
			for (int i = 1; i <= elements.size(); i++) {
				String SearchText = driver.findElement(By.xpath(
						MainThread.CONFIG.getProperty(tar[0]) + "[" + i + "]" + MainThread.CONFIG.getProperty(tar[1])))
						.getText();
				System.out.println("SearchText=" + SearchText);
	...
	public String verifyLMSearchAddCharByChar(WebDriver driver, String browser, String target, String data,
			File SubFolderPath, String TCID, String TSID, String DSID, String Correct_Data, int currentTestDataSetID,
			String user, Xlsx_Reader currentTestSuiteXLS, String currentTestCaseName)
			throws InterruptedException, IOException {
		// APP_LOGS.debug("Input The Value In Test Box");
		try {
			...
			for (int j = 0; j < data.length(); j++) {
				driver.findElement(By.xpath(MainThread.CONFIG.getProperty(tar[0])))
						.sendKeys(Character.toString(data.charAt(j)));
				List<WebElement> elements = driver.findElements(By.xpath(MainThread.CONFIG.getProperty(tar[1])));
				for (int i = 1; i <= elements.size(); i++) {
					String SearchText1 = driver
							.findElement(
									By.xpath(MainThread.CONFIG.getProperty(tar[1]) + "[" + i + "]" + "/td[" + 1 + "]"))
							.getText();
					String SearchText2 = driver
							.findElement(
									By.xpath(MainThread.CONFIG.getProperty(tar[1]) + "[" + i + "]" + "/td[" + 2 + "]"))
							.getText();
					String SearchText3 = driver
							.findElement(
									By.xpath(MainThread.CONFIG.getProperty(tar[1]) + "[" + i + "]" + "/td[" + 3 + "]"))
							.getText();
					String SearchText4 = driver
							.findElement(
									By.xpath(MainThread.CONFIG.getProperty(tar[1]) + "[" + i + "]" + "/td[" + 4 + "]"))
							.getText();
					String SearchText5 = driver
							.findElement(
									By.xpath(MainThread.CONFIG.getProperty(tar[1]) + "[" + i + "]" + "/td[" + 5 + "]"))
							.getText();
					String InputSearchText = driver.findElement(By.xpath(MainThread.CONFIG.getProperty(tar[0])))
							.getAttribute("value");
					System.out.println("SearchText=" + SearchText1 + "==" + SearchText2 + "==" + SearchText3 + "=="
							+ SearchText4 + "==" + SearchText5);
					System.out.println("InputSearchText=" + InputSearchText);
					if (SearchText1.contains(InputSearchText) || SearchText2.contains(InputSearchText)
							|| SearchText3.contains(InputSearchText) || SearchText4.contains(InputSearchText)
							|| SearchText5.contains(InputSearchText)) {
						continue;
					} else {
						ScreenShot(driver, browser, target, data, SubFolderPath, TCID, TSID, DSID, Correct_Data,
								currentTestDataSetID, user, currentTestSuiteXLS, currentTestCaseName);
